 ...
 *     should be run on, and optionally `--trainToTestRatio 10` to specify the ratio of
 *     train rows to test rows.  By default the ratio is 10 train rows to 1 test row.
 */
